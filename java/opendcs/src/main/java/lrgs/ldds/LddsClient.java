    ...
    */
        ...
        throws ServerError, ProtocolError, IOException
    {
        ...
        if (st.countTokens() >= 2)
        {
            ...
            try
            {
                serverProtoVersion = Integer.parseInt(s);
            }
    ...
    */
        ...
        throws ServerError, ProtocolError, IOException
    {
        ...
        try
        {
            ...
            serverProtoVersion = Integer.parseInt(serverProtoVersionStr.substring(0, i));
        }
        catch(NumberFormatException ex)
        {
            Logger.instance().warning(module +
        ...
        throws IOException, ProtocolError, ServerError
    {
        ...
        if (st != null)
        {
            ...
            if (TextUtil.startsWithIgnoreCase(st,"filetime("))
            {
                ...
                File f = new File(fn);
                long t;
                if (!f.exists() || (t = f.lastModified()) <= 0)
                {
...
//                msg.MsgLength - 40);
    ...
    */
    ...
    /**
      ...
      are connected.
    */
    public int getServerProtoVersion()
    {
        ...
        throws AuthException
    {
        ...
        {
            throw new AuthException("Cannot set user info: " + ex.getLocalizedMessage(),ex);
        }
        ...
        if (pw != null && pw.length() > 0 && serverProtoVersion >= DdsVersion.version_13)
        {
            ...
            {
                throw new AuthException("Cannot set user password: " + ex.getLocalizedMessage(),ex);
            }
        }
    }
